...
const withList = (List: any) => {
  function DataList(props: any) {
    const {
      ...
      limit,
      reversed,
      renderWhenEmpty, // render/list related props
    ...
    if (sortOptions.by || sortBy || (isBoolean(sort) && sort)) {
      renderList = sortList(renderList, {
        ...
        descending: sortOptions.descending || sortDescending || sortDesc, // deprecated
    ...
    if (
      ...
      renderList = gList.groupLists.reduce(
